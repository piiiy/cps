...
document.addEventListener('DOMContentLoaded', function () {
  var callButton = document.querySelector('.mobile-menu__button-call');
  var headerCallButton = document.querySelector('.header__button-call');
  var modalCall = document.querySelector('.modal-call');
  var closeButton = document.querySelector('.modal-call__close-button');
...
document.addEventListener('DOMContentLoaded', function () {
  var feedbackButton = document.querySelector('.mobile-menu__button-chat');
  var headerChatButton = document.querySelector('.header__button-chat');
  var modalFeedback = document.querySelector('.modal-feedback');
  var closeButton = document.querySelector('.modal-feedback__close-button');
  var overlay = document.querySelector('.modal-overlay');
  function openModal() {
...
;// ./src/assets/main-icons/expand.svg
const expand_namespaceObject = "data:image/svg+xml;base64,";
;// ./src/assets/main-icons/expandVverh.svg
const expandVverh_namespaceObject = "data:image/svg+xml;base64,";
;// ./src/js/slider.js
...
var servicesSlider = new Swiper('.technics__slider', {
  modules: [Pagination],
  slidesPerView: 'auto',
  spaceBetween: 16,
  slidesOffsetBefore: 16,
...
var priceSlider = new Swiper('.price__slider', {
  modules: [Pagination],
  slidesPerView: 'auto',
  spaceBetween: 16,
...
function checkPriceScreenSize() {
  var priceSliderBlock = document.querySelector('.price__slider');
...
// EXTERNAL MODULE: ./src/js/modal-feetback.js
var modal_feetback = __webpack_require__(965);
// EXTERNAL MODULE: ./src/js/modal-call.js
var modal_call = __webpack_require__(66);
;// ./src/main.js
